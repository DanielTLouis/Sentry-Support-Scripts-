...
install_openManage()
{
  ...
  sudo cp "$SCRIPT_DIR/../open_manage/OM-SrvAdmin-Dell-Web-LX-11.0.1.0-5494.SLES15.x86_64_A00.tar.gz" /usr/Dell_OpenManage/OM-SrvAdmin-Dell-Web-LX-11.0.1.0-5494.SLES15.x86_64_A00.tar.gz
